<?php
	...
	if(isset($_GET['username']) === true && empty($_GET['username']) === false){
		...
		$username 	 = $getUser->checkInput($_GET['username']);
		$profileID 	 = $getUser->userIdByUsername($username);
		$profileData = $getUser->userData($profileID);
...
<html>
	<head>
		<title>twitter</title>
		<meta charset="UTF-8" />
		<link rel="stylesheet" href="assets/css/font/css/font-awesome/4.6.3/css/font-awesome.css"/>
